  ...
  return (
    ...
    >
      ...
      {isOpen && (
        ...
        >
          <Link
            className="py-2 pr-16 pl-3  w-full rounded-xl hover:bg-blockground/70 transition-all duration-300 flex items-center gap-2"
            href="/addPost"
          >
            <Share />
            <span>Поделится</span>
          ...
          <Link
            className="py-2 pr-16 pl-3  w-full rounded-xl hover:bg-blockground/70 transition-all duration-300 items-center flex gap-2"
            href="#"
          >
            <Ban />
          ...
          <Link
            className="py-2 pr-16 pl-3 text-red-600  w-full rounded-xl hover:bg-blockground/70 transition-all duration-300 items-center flex gap-2"
            href="#"
          >
            <Trash />
            <span>Удалить</span>
